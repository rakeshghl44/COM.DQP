...
public class CreateMeasureAndJobTestPage extends TestBase{
  ...
  public void verifyMeasureTab() throws InterruptedException {
	 ...
	 public void verifyMesureData() throws InterruptedException { 
		 ...
		 createMeasureAndJobPage.validateMesureType();Thread.sleep(6000);
		 ...
		 createMeasureAndJobPage.validateCronExpression(); Thread.sleep(7000);
		 driver.manage().timeouts().implicitlyWait(10000, TimeUnit.SECONDS);
		 createMeasureAndJobPage.validateSelectCronExpression(); Thread.sleep(8000);
		 createMeasureAndJobPage.validateEnterCustomCronExp(); Thread.sleep(7000);
		 createMeasureAndJobPage.validateBeginValue(); Thread.sleep(5000);
		 createMeasureAndJobPage.validateEndValue(); Thread.sleep(5000);
		 createMeasureAndJobPage.validateJobSubmitButton(); Thread.sleep(8000);
