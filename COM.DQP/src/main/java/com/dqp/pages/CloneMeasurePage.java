...
public class CloneMeasurePage extends TestBase{
	...
	@FindBy(xpath = "//div[@title='clone']//preceding-sibling::div//following-sibling::span//following-sibling::span//fa-icon//*[local-name()='svg' and @data-icon='copy']")
	WebElement cloneMeasure;
	...
	public void validateCloneMeasure() throws InterruptedException {
		cloneMeasure.click(); 
		Thread.sleep(2000); }
